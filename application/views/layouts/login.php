<?php Header("Cache-Control: public, max-age=172800");?>
<!DOCTYPE html>
<html>
...
<script type="text/javascript" src="<?= $this->config->item('base_url') ?>/public/javascripts/jquery/jquery-1.11.1.min.js"></script>
