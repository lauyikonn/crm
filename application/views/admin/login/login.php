		...
		<div id="login-wrapper" class="png_bg">
			<div id="login-top">
				<img src="<?= $this->config->item('domain') ?>/public/images/geonn-solution.png" alt="<?= $this->config->item('project_name') ?> admin" style='width:75%;'  title="Powered By GEONN SOLUTION">			
			</div>
